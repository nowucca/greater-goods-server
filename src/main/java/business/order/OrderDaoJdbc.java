...
public class OrderDaoJdbc implements OrderDao {
    ...
    private static final String CREATE_ORDER_SQL =
            "INSERT INTO `order` (amount, confirmation_number, customer_id) " +
                    "VALUES (?, ?, ?)";

    private static final String FIND_ALL_SQL =
            "SELECT order_id, customer_id, amount, date_created, confirmation_number " +
                    "FROM order";
    ...
    public long create(Connection connection, int amount, int confirmationNumber, long customerId) {
        try (PreparedStatement statement = connection.prepareStatement(CREATE_ORDER_SQL, Statement.RETURN_GENERATED_KEYS)) {
            ...
            if (affected != 1) {
                throw new DbException("Failed to insert an order, affected row count = " + affected);
            }
            ...
            if (rs.next()) {
                ...
                throw new DbException("Failed to retrieve customerOrderId auto-generated key");
            }
    ...
    public List<Order> findAll() {
        ...
        try (Connection connection = getConnection();
            ...
            throw new DbException("Encountered problem finding all orders", e);
        }
        return result;
    }
    ...
    public Order findByOrderId(long orderId) {
        ...
        try (Connection connection = getConnection();
            ...
            throw new DbException("Encountered problem finding customer order id = " + orderId, e);
        }
        return result;
    }
    ...
    public List<Order> findByCustomerId(long customerId) {
        ...
        try (Connection connection = getConnection();
            ...
            throw new DbException("Encountered problem finding customer id = " + customerId, e);
        }
        return result;
    }
